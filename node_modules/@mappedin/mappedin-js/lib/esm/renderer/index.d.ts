...
declare module '@mappedin/mappedin-js/renderer/private/controllers/OutdoorViewController' {
    ...
    export type TOutdoorViewOptionsWithHeaders = {
            ...
            /**
                * If set to true, the map will be rendered in dpi=1 mode, which should make performance better
                */
            lowDPI?: boolean;
    };
    /**
...
declare module '@mappedin/mappedin-js/renderer/private/controllers/StackedMapsController' {
    ...
    class StackedMapsController {
        ...
        transitionInProgress: Promise<undefined>;
...
declare module '@mappedin/mappedin-js/renderer/private/Core' {
    ...
    import type { TGetPolygonsAtCoordinateOptions, TMapViewOptions, TPadding, MappedinPolygon, MapManager, FlatLabel, INTERNAL_EVENT_PAYLOAD, MapView } from '@mappedin/mappedin-js/renderer/internal';
    import { Renderer, TaskScheduler, SmartCollisionEngine, PubSub, INTERNAL_EVENT, STATE, MapObject, SceneManager, TileManager, PathsController, FloatingLabelsController, FlatLabelsController, PolygonColorsController, MarkersController, PolygonInteractionController, TooltipsController, PolygonStatesController, PolygonImagesController, ThreeDMarkersController, EventSystem, BlueDotController, CameraController, BillboardManager, StackedMapsController, OutdoorViewController, WatermarkController, PolygonHoverColorsController, ExportController, LayerController } from '@mappedin/mappedin-js/renderer/internal';
    import type { Mappedin as IMappedin, MappedinCoordinate, MappedinMap, MappedinNode } from '@mappedin/mappedin-js/get-venue';
    import type { E_MAP_CHANGED_REASON } from '@mappedin/mappedin-js/renderer/MapView.enums';
...
declare module '@mappedin/mappedin-js/get-venue/MappedinPolygon' {
    import type { MappedinNode, MappedinLocation, Mappedin, MappedinCoordinate } from '@mappedin/mappedin-js/get-venue/internal';
